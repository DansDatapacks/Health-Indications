...
execute if score #healthindications.option.health_bar.affect_players sourcecraft.data matches 0 as @e[type=!#sourcecraft.5:no_health,tag=healthindications.active_health_bar] at @s run function healthindications.2:health_bar/end_health_bar
