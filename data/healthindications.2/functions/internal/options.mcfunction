...
#better sync
execute if score #healthindications.option.health_bar.toggle sourcecraft.data matches 1 if score #healthindications.option.health_bar.better_sync sourcecraft.data matches 1 run tellraw @s [{"text":"|","color":"gray"},{"text":" "},{"text":"[Better Sync]","color":"green","clickEvent":{"action":"run_command","value":"/function healthindications.2:internal/option/health_bar/better_sync"},"hoverEvent":{"action":"show_text","contents":[{"text":"Makes Healthbars Ride Entities. Does not work on Players or Saddled Entities. (ON)","color":"gray"}]}}]
execute if score #healthindications.option.health_bar.toggle sourcecraft.data matches 1 unless score #healthindications.option.health_bar.better_sync sourcecraft.data matches 1 run tellraw @s [{"text":"|","color":"gray"},{"text":" "},{"text":"[Better Sync]","color":"red","clickEvent":{"action":"run_command","value":"/function healthindications.2:internal/option/health_bar/better_sync"},"hoverEvent":{"action":"show_text","contents":[{"text":"Makes Healthbars Ride Entities. Does not work on Players or Saddled Entities. (OFF)","color":"gray"}]}}]

#dont sync ridable mobs (requires Better Sync to be on)
execute if score #healthindications.option.health_bar.toggle sourcecraft.data matches 1 if score #healthindications.option.health_bar.better_sync sourcecraft.data matches 1 if score #healthindications.option.health_bar.dont_sync_ridables sourcecraft.data matches 1 run tellraw @s [{"text":"|","color":"gray"},{"text":" "},{"text":"[Don't Sync Ridable Mobs]","color":"green","clickEvent":{"action":"run_command","value":"/function healthindications.2:internal/option/health_bar/dont_sync_ridables"},"hoverEvent":{"action":"show_text","contents":[{"text":"Disables Better Sync on Ridable Mobs (ON)","color":"gray"}]}}]
execute if score #healthindications.option.health_bar.toggle sourcecraft.data matches 1 if score #healthindications.option.health_bar.better_sync sourcecraft.data matches 1 unless score #healthindications.option.health_bar.dont_sync_ridables sourcecraft.data matches 1 run tellraw @s [{"text":"|","color":"gray"},{"text":" "},{"text":"[Don't Sync Ridable Mobs]","color":"red","clickEvent":{"action":"run_command","value":"/function healthindications.2:internal/option/health_bar/dont_sync_ridables"},"hoverEvent":{"action":"show_text","contents":[{"text":"Disables Better Sync on Ridable Mobs (OFF)","color":"gray"}]}}]
