...
#predictive syncing
execute if score #healthindications.option.health_bar.toggle sourcecraft.data matches 1 if score #healthindications.option.health_bar.predictive_syncing sourcecraft.data matches 1 run tellraw @s [{"text":"|","color":"gray"},{"text":" "},{"text":"[Predictive Syncing]","color":"green","clickEvent":{"action":"run_command","value":"/function healthindications.2:internal/option/health_bar/predictive_syncing"},"hoverEvent":{"action":"show_text","contents":[{"text":"Syncs Health Bars To Their Entities More Accurately (ON)","color":"gray"}]}}]
execute if score #healthindications.option.health_bar.toggle sourcecraft.data matches 1 unless score #healthindications.option.health_bar.predictive_syncing sourcecraft.data matches 1 run tellraw @s [{"text":"|","color":"gray"},{"text":" "},{"text":"[Predictive Syncing]","color":"red","clickEvent":{"action":"run_command","value":"/function healthindications.2:internal/option/health_bar/predictive_syncing"},"hoverEvent":{"action":"show_text","contents":[{"text":"Syncs Health Bars To Their Entities More Accurately (OFF)","color":"gray"}]}}]
