...
execute as @e[type=!#sourcecraft.3:no_health,tag=healthindications.tracking_health,tag=!healthindications.init_health_percent,tag=!healthindications.ignore] run function healthindications.2:health/get_health_percent
