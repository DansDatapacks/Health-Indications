...
execute at @e[type=minecraft:marker,tag=sourcecraft.air_detector] run data modify entity @e[tag=healthindications.damage_indicator_init,limit=1] CustomName set from block ~ ~ ~ Text1
