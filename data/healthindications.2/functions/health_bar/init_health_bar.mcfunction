...
execute if score #healthindications.option.health_bar.better_sync sourcecraft.data matches 1 unless score #healthindications.option.health_bar.sync_ridables sourcecraft.data matches 1 if entity @s[type=#healthindications.2:ridable] run tag @e[type=minecraft:text_display,tag=healthindications.health_bar.init,limit=1] add healthindications.health_bar.better_sync.ignore
execute if score #healthindications.option.health_bar.better_sync sourcecraft.data matches 1 unless score #healthindications.option.health_bar.sync_ridables sourcecraft.data matches 1 if entity @s[type=#healthindications.2:saddleable] if data entity @s {Saddle:1b} run tag @e[type=minecraft:text_display,tag=healthindications.health_bar.init,limit=1] add healthindications.health_bar.better_sync.ignore
