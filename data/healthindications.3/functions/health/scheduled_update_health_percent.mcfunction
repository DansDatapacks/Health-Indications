...
execute as @e[type=!#sourcecraft.3:no_health,tag=healthindications.update_health_percent,tag=!healthindications.ignore] run function healthindications.3:health/get_health_percent
