...
execute if score #healthindications.option.health_bar.toggle sourcecraft.data matches 1 if score #healthindications.option.health_bar.custom_texture sourcecraft.data matches 1 if score #healthindications.option.health_bar.status_effects sourcecraft.data matches 1 if entity @s[tag=!global.ignore,tag=!healthindications.ignore,tag=!healthindications.no_status_effects,tag=healthindications.check_status_effects] run function healthindications.3:status_effect/check_status_effect

# prevent healthbars from showing on mobs with invisibility
execute if predicate healthindications.3:status_effect/invisibility run scoreboard players reset @s healthindications.health_bar.update
execute if predicate healthindications.3:status_effect/invisibility run function healthindications.3:health_bar/end_health_bar

#update health related indications
execute if score @s healthindications.health_bar.update matches 1 run function healthindications.3:health/mob_health_update
