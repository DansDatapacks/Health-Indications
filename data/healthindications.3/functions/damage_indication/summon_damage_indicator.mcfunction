...
# schedule motion
execute unless score #healthindications.option.damage_indication.stationary sourcecraft.data matches 1 run schedule function healthindications.3:damage_indication/apply_motion 1t replace
