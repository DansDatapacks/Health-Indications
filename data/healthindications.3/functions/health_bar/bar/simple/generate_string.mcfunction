...
#full bar
execute if score #healthindications.current_percent sourcecraft.temp > #healthindications.half_of_interval sourcecraft.temp run data merge block ~ ~ ~ {Text1:'[{"nbt":"Text1","block":"~ ~ ~","interpret":true},{"nbt":"icon.health_bar.full","storage":"healthindications","interpret":true}]'}

#half empty bar
execute unless score #healthindications.current_percent sourcecraft.temp > #healthindications.half_of_interval sourcecraft.temp if score #healthindications.current_percent sourcecraft.temp matches 1.. run data merge block ~ ~ ~ {Text1:'[{"nbt":"Text1","block":"~ ~ ~","interpret":true},{"nbt":"icon.health_bar.half","storage":"healthindications","interpret":true}]'}

#empty bar
execute unless score #healthindications.current_percent sourcecraft.temp > #healthindications.half_of_interval sourcecraft.temp unless score #healthindications.current_percent sourcecraft.temp matches 1.. run data merge block ~ ~ ~ {Text1:'[{"nbt":"Text1","block":"~ ~ ~","interpret":true},{"nbt":"icon.health_bar.empty","storage":"healthindications","interpret":true}]'}
